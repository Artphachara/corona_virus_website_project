            ...
            <div class="navigator">
                <div class="nav">
                    <ul>
                        ...
                        <li><a href="news-login.php">News</a></li>
            ...
            <div class="videos">
                ...
                <div class="description-video">
                    ...
                    <p>
                        ...
                        <br>
                        <br>
                        <a href="protect-login.php">see all</a>
                    </p>
                </div>
            </div>
            <div class="home-news">
                <div class="heading-news">
                    News
                    <div class="all-news">
                        <a href="news-login.php">All <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="box-news">
                ...
                <div class="protect-news">
                    ...
                    <div class="box-protect-news">
                        <table>
                            <tr>
                                <td><a href="coronavirus-login.html" target="_blank">What is a coronavirus? <i class="fas fa-arrow-right"></i></a></td>
                            </tr>
                            <tr>
                                <td><a href="how-to-protect-login.html">How to protect yourself <i class="fas fa-arrow-right"></i></a></td>
                            </tr>
                            <tr>
                                <td><a href="how-to-protect-login.html">Q&A on coronaviruses (COVID-19) <i class="fas fa-arrow-right"></i></a></td>
                            </tr>  
                        </table>
                    </div>
                </div>                      
